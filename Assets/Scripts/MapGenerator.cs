...
public class MapGenerator : MonoBehaviour {
    ...
    void Awake() {
        GenerateMap();
        FindObjectOfType<Spawner>().OnNewWave += GenerateMapOnNewWave;
    }

    void GenerateMapOnNewWave(int waveNumber) {
    ...
    public struct Coord {
        ...
        // Boilerplate code generated by Visual Studio to silence Unity warning
